    ...
    public ConnectionPool(int poolSize) {
        ...
        try {
            ...
            for (int i = 0; i < poolSize; i++) {
                Connection  connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/dep9_lms","root","MYsql.123");
                pool.add(connection);
